    ...
    <div className="p-6 border rounded-2xl bg-slate-900/60 border-slate-800/80 backdrop-blur-sm space-y-5">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="p-4 rounded-xl bg-slate-950/60 border border-slate-800 space-y-1">
          ...
          <p className="text-[11px] text-slate-400">Net space reclaimed</p>
        </div>
        ...
        <div className="p-4 rounded-xl bg-slate-950/60 border border-slate-800 space-y-1">
          ...
          <p className="text-[11px] text-slate-400">Emissions avoided</p>
        </div>
        ...
        <div className="p-4 rounded-xl bg-slate-950/60 border border-slate-800 space-y-1">
          ...
          <p className="text-[11px] text-slate-400">Scans executed</p>
        </div>
      </div>
    </div>
  )
