...
export default function SettingsView() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Tabs bar */}
      <div className="flex flex-wrap gap-2 p-1.5 bg-card/40 border border-glass-border rounded-xl backdrop-blur-md">
        {tabs.map((tab) => {
          const Icon = tab.icon
      ...
      {/* Tab Panels */}
      <div className="p-6 md:p-8 border rounded-2xl bg-card/40 border-glass-border backdrop-blur-md space-y-8">
        {/* TAB 1: THRESHOLDS */}
        {activeTab === 'thresholds' && (
          ...
          >
            ...
            {/* Large Files Cutoff */}
            <div className="space-y-3 p-5 rounded-xl bg-slate-900/60 border border-glass-border">
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        isSelected
                          ...
                          : 'border-glass-border bg-slate-800/40 text-gray-300 hover:border-gray-600 hover:bg-slate-800/80'
                      )}
                    >
            ...
            <div className="space-y-4 p-5 rounded-xl bg-slate-900/60 border border-glass-border">
              <div>
        ...
        {activeTab === 'scanning' && (
          ...
          >
            ...
            {/* Default Drive Scope */}
            <div className="p-5 rounded-xl bg-slate-900/60 border border-glass-border space-y-3">
              <label className="text-base font-medium text-gray-200">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    scanning.defaultCorpora === 'user'
                      ...
                      : 'border-glass-border bg-slate-800/40 text-gray-300 hover:bg-slate-800/80'
                  )}
                >
            ...
            <div className="p-5 rounded-xl bg-slate-900/60 border border-glass-border flex items-center justify-between">
              <div>
            ...
            <div className="p-5 rounded-xl bg-slate-900/60 border border-glass-border space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3 pt-1">
                ...
                >
                  ...
                  <div className="text-xs text-gray-400">Standard table padding and larger icons</div>
                </button>
                ...
                >
                  ...
                  <div className="text-xs text-gray-400">Higher file density for power users</div>
                </button>
              </div>
            </div>
          </motion.div>
